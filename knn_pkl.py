#!/usr/bin/env python3
"""
Script to train KNN model and save it as a pickle file.
"""
...
def main():
    try:
        print("=" * 70)
        print("K-NEAREST NEIGHBORS MODEL - PICKLE GENERATION")
        print("=" * 70 + "\n")
        ...
        print("⏳ Building and training KNN...")
        model = Pipeline([
        ...
        pkl_path = 'model/pickles/knn.pkl'
