...
#!/usr/bin/env python3
"""
Standalone script for training and evaluating Logistic Regression on fetal_health.csv
...
def main():
        ...
        pd.DataFrame(cm).to_csv('logistic_regression_confusion_matrix.csv', index=False)
