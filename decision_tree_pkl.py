#!/usr/bin/env python3
"""
Script to train Decision Tree model and save it as a pickle file.
"""
...
def main():
    try:
        print("=" * 70)
        print("DECISION TREE MODEL - PICKLE GENERATION")
        print("=" * 70 + "\n")
        ...
        print("⏳ Building and training Decision Tree...")
        model = Pipeline([
        ...
        pkl_path = 'model/pickles/decision_tree.pkl'
